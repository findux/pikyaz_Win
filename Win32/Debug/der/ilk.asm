    ...
    include C:\_PikYaz\Pikyaz\Win32\Debug\der\ortak\makrolar.asm
   errorlevel -302 
   radix    dec 
cblock 0x20 
...
endc 
              org 0x000 
              goto _BAS
     CLRF ADCON0 ;clear ADCON0 to select channel
     MOVLW 0x0E;VSS,VDD ref. AN0 analog only
     MOVWF ADCON1
     MOVLW 0xA6 ;ADCON2 setup: Left justified, Tacq=2Tad, Tad=2*Tosc (or Fosc/2)
     MOVWF ADCON2

...
begin
  temiz;
  { TODO -oeyüp -cGeneral : ( karakterine göre ayrým her durum için uyarmý kontrol et }
  m.Clear;
  m.Delimiter := '(';
  m.StrictDelimiter := True;
  m.DelimitedText := yazi;
...
begin
  ...
  begin
    if Pos(';', sl[i]) > 0 then  // eðer satýrda yorum varsa, satýrdaki ilk gördüðü ; karakterinden sonrasýný trimler
